...
| `gen_board_skeleton.py` | `hardware/pcb/caryatid.kicad_pcb` | **spent** — outline, M3 holes, stackup |
| `place_board.py` | same file | **spent** — placed 125 footprints and bound their nets |
